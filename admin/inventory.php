...
<div class="content">
	...
	<table border=0 width="100%" cellspacing="5" cellpadding="5" style="box-shadow: 5px 4px 10px 2px;">
		...
		<tr>
			<th colspan="2">Upload Your Image Here &nbsp;&nbsp;&nbsp;&nbsp; <a href="vinventory.php">View Inventory</a></th>
		</tr>
		<tr>
			<th>&nbsp;</th>
		</tr>
	...
	if(isset($_POST['sb']))
	{
		...
		include "connect.php";
		mysqli_query($con,"insert into inventory(image)values('$i')") or die(mysqli_error($con));
