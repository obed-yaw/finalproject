		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Digistic Pharmaceuticals</strong></h1>
							<p class="m-b-40">Have It Your Way,   <br> 
							World's Best Pharmacy</p>
							<p><a class="btn btn-lg btn-circle btn-outline-new-white" href="menu.php">Store</a></p>
						</div>
					</div>
				</div>
			</li>
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>We like  <br> to help.</strong></h1>
							<p class="m-b-40">One of the world's best chain supplier 
<br> 
							We deliver to you!</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					<p class="lead ">
						" The best in drugs and services. "
					</p>
					<span class="lead">Digistic Pharmacy</span>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Inventory</h2>
						<p>Some drugs in our inventory.</p>
					</div>
				</div>
			</div>
